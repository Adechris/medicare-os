      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card className="p-4">
          <h3 className="font-display font-bold text-sm flex items-center gap-2">
            <SettingsIcon className="h-4 w-4 text-primary" /> Pharmacy Info
          </h3>
        ...
        <Card className="p-4">
          <h3 className="font-display font-bold text-sm flex items-center gap-2">
            <Wifi className="h-4 w-4 text-primary" /> API Configuration
          </h3>
          <div className="mt-3 space-y-3 text-sm">
            <div>
              <div className="text-xs font-semibold text-muted-foreground">VITE_API_BASE_URL</div>
              <div className="mt-1 px-3 py-2 rounded-lg bg-surface-grey border border-border font-mono text-xs">
                {API_BASE_URL}
              </div>
            </div>
            ...
            <Button variant="outline" onClick={() => toast.success("API responded in 142ms")}>
              Test API Connection
            </Button>
          </div>
        </Card>
  ...
  return (
    <div>
      ...
      <input
        ...
        className="mt-1 w-full h-9 px-3 rounded-lg border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary"
      />
    </div>
  );
}
