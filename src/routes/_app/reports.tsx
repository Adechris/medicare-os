...
function ReportsPage() {
  ...
  return (
    <div>
      <PageHeader title="Reports" description="Sales, financial and inventory analytics"
        actions={<><Button variant="outline"><Download className="h-4 w-4"/> Export CSV</Button><Button><FileBarChart className="h-4 w-4"/> Export PDF</Button></>}/>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
          ...
          <div className="h-60 mt-3">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={rev.data||[]} margin={{left:-10,right:8}}>
                <defs><linearGradient id="r2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#2B7FFF" stopOpacity={0.35}/><stop offset="100%" stopColor="#2B7FFF" stopOpacity={0}/></linearGradient></defs>
        ...
        <Card className="p-4 lg:col-span-2">
          ...
          <div className="h-72 mt-3">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie data={expensePie} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={100} innerRadius={60} paddingAngle={3}>
