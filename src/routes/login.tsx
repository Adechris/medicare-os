    ...
    <div className="min-h-screen relative flex items-center justify-center px-4 py-10 bg-gradient-to-br from-[#2B7FFF] via-[#1A5FCC] to-[#0D1B2A]">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center h-14 w-14 rounded-2xl bg-white text-primary font-display font-bold text-2xl shadow-lg">M+</div>
          ...
          <form onSubmit={submit} className="mt-5 space-y-4">
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <button type="button" onClick={()=>setShow(!show)} className="absolute right-2 top-1/2 -translate-y-1/2 h-7 w-7 inline-flex items-center justify-center rounded-md hover:bg-accent">
        ...
        <p className="mt-6 text-center text-xs text-white/70">© {new Date().getFullYear()} MediCare Pharmacy. All rights reserved.</p>
      </div>
    </div>
  );
}
